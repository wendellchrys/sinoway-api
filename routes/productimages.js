...
router
  ...
  .delete(passport.authenticate("jwt", { session: false }), (req, res) => {
    ...
    if (rolesControl[roleTitle + "delete"]) {
      Productimages.findByIdAndDelete(req.params.id)
        .then(() =>
          res.json({
...
router
  ...
  .post(passport.authenticate("jwt", { session: false }), (req, res) => {
    ...
    if (rolesControl[roleTitle + "/id"]) {
      Productimages.findByIdAndUpdate(req.params.id, req.body)
        .then(() =>
          res.json({
      ...
      Productimages.findOneAndUpdate(
        {
          _id: req.params.id,
          "created_user.id": `${req.user._id}`,
        },
